...
public class Container {
    ...
    public static final String DEFAULT_GRAPHICS_DRIVER = android.os.Build.MANUFACTURER.equalsIgnoreCase("PICO") ? "turnip" : "virgl-23.1.9";
    public static final String DEFAULT_AUDIO_DRIVER = "alsa";
    public static final String DEFAULT_DXWRAPPER = android.os.Build.MANUFACTURER.equalsIgnoreCase("PICO") ? "dxvk" : "wined3d";
